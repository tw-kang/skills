...
1. **Locate the testcase** — cdc_repl tests live at `cdc_repl/{test}/cases/{test}.sql`. From a partial name or CBRD number: `find ~/cubrid-testcases -path '*/cdc_repl/*/cases/*.sql' -name '<pattern>.sql'`.
